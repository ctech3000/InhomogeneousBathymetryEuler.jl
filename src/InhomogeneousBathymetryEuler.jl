...
using Interpolations, Ferrite, SparseArrays, ProgressBars, JLD, BSplineKit, PlutoUI, DelimitedFiles, FFTW
...
export firstDerivative, secondDerivative, dofToCoordinate
