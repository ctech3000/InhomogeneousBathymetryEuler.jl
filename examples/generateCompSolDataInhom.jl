...
wave_irreg, amp0, wave_time = IrregWave("examples/irregWaveData_noBathy.jld2")
...
jldsave("compSolDataInhom_HomSignal.jld2";all_etas_irreg, sensors_irreg, all_etas_reg, sensors_reg, wave_irreg, wave_reg, domain, χs, σs, time_vec, wave_time, amp0)