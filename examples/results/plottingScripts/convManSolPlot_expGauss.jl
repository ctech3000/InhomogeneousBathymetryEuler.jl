...
data = load("examples/results/plottingScripts/convManSolData_expGauss.jld2")
errorsL2 = data["errorsL2"]
errorsMax = data["errorsMax"]
Dχs = data["Dχs"]
nGrids, nBaths = size(errorsL2)
baths = [L"\hat{b}_1",L"\hat{b}_2",L"\hat{b}_3"]
...
#save("C:\\Users\\chris\\Desktop\\Masterarbeit\\Text\\masterthesis\\clean-math-thesis\\images\\manSolErr_expGauss.svg",fig1)
fig1