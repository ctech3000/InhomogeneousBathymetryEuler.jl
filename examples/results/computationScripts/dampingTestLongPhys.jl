...
#wave = SimpleWave(inflowDepth=0.3)
...
time_vec = collect(LinRange(0,T,nt))
jldsave("examples/results/plottingScripts/dampingTestLongPhysData.jld2";etas,energies,Dχs,Dσs,Dts,domains,wave,transs,time_vec,χss)